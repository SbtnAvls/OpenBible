...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo<ThemeContextValue>(() => {
    ...
    const accentPreset =
      ACCENT_PRESETS.find(p => p.name === accentColor) ?? ACCENT_PRESETS[0];
    const accentColors =
      theme === 'Claro' ? accentPreset.light : accentPreset.dark;
...
export const accentColorOptions: AccentColorName[] = [
  'Sunset',
  'Ocean',
  'Forest',
  'Lavender',
