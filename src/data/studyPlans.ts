...
export const studyPlans: StudyPlan[] = [
  {
    ...
    description: "Recorrido desde el anuncio de su nacimiento hasta la resurrección y ascensión.",
    progress: 0,
    sections: [
      {
        id: "nacimiento-infancia",
        title: "Nacimiento, infancia y preparación",
        description: "El inicio de la vida terrenal de Jesús, desde su nacimiento hasta el comienzo de su ministerio.",
        isUnlocked: true,
        isCompleted: false,
        readings: [
          {
          ...
          },
          {
            ...
            verseRanges: [
              { chapter: 1, startVerse: 1, endVerse: 18 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 3, startVerse: 21, endVerse: 38 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 3, startVerse: 1, endVerse: 17 },
            ],
          ...
          },
          {
            ...
            verseRanges: [
              { chapter: 1, startVerse: 1, endVerse: 11 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 3, startVerse: 1, endVerse: 20 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 4, startVerse: 1, endVerse: 11 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 1, startVerse: 12, endVerse: 13 },
            ],
            description: "La tentación de Jesús",
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 4, startVerse: 1, endVerse: 13 },
            ],
            description: "La tentación de Jesús",
          },
        ],
      },
      {
        ...
        description: "Enseñanza, milagros y llamado de discípulos durante el ministerio en Galilea.",
        isUnlocked: false,
        isCompleted: false,
        readings: [
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 4, startVerse: 12, endVerse: 25 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 1, startVerse: 14, endVerse: 45 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 4, startVerse: 14, endVerse: 44 },
            ],
            description: "Inicio del ministerio",
          },
          {
          ...
          },
          {
            ...
            description: "Bodas de Caná, Nicodemo, samaritana, sanidades, alimentación de los 5,000",
          },
        ],
      },
      {
        ...
        description: "Enseñanza intensiva a los discípulos en el viaje hacia Jerusalén.",
        isUnlocked: false,
        isCompleted: false,
        readings: [
          {
      ...
      },
      {
        ...
        description: "Los últimos días de Jesús, su muerte y resurrección gloriosa.",
        isUnlocked: false,
        isCompleted: false,
        readings: [
          {
  ...
  },
  {
    ...
    description: "Pasajes clave para estudiar sus milagros y comprender su poder divino.",
    progress: 0,
    sections: [
      {
        id: "resumen-general",
        title: "Resumen general de ministerio milagroso",
        description: "Una visión amplia del ministerio de milagros de Jesús en los cuatro evangelios.",
        isUnlocked: true,
        isCompleted: false,
        readings: [
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 4, startVerse: 23, endVerse: 25 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 11, startVerse: 2, endVerse: 6 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 12, startVerse: 9, endVerse: 14 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 14, startVerse: 13, endVerse: 36 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 15, startVerse: 29, endVerse: 39 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 1, startVerse: 21, endVerse: 45 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 9, startVerse: 14, endVerse: 29 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 4, startVerse: 31, endVerse: 41 },
            ],
            description: "Primeros milagros de Jesús",
          },
          {
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 13, startVerse: 10, endVerse: 17 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 17, startVerse: 11, endVerse: 19 },
            ],
        ...
        readings: [
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 8, startVerse: 1, endVerse: 17 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 9, startVerse: 1, endVerse: 8 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 9, startVerse: 18, endVerse: 34 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 20, startVerse: 29, endVerse: 34 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 1, startVerse: 29, endVerse: 34 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 1, startVerse: 40, endVerse: 45 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 2, startVerse: 1, endVerse: 12 },
            ],
            description: "El paralítico",
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 3, startVerse: 1, endVerse: 6 },
            ],
            description: "El hombre de la mano seca",
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 5, startVerse: 21, endVerse: 43 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 7, startVerse: 31, endVerse: 37 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 8, startVerse: 22, endVerse: 26 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 5, startVerse: 12, endVerse: 26 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 7, startVerse: 1, endVerse: 10 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 8, startVerse: 40, endVerse: 56 },
            ],
            description: "La mujer con flujo de sangre y la hija de Jairo",
          },
          {
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Juan"],
            verseRanges: [
              { chapter: 4, startVerse: 46, endVerse: 54 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Juan"],
            verseRanges: [
              { chapter: 5, startVerse: 1, endVerse: 15 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Juan"],
            verseRanges: [
              { chapter: 9, startVerse: 1, endVerse: 41 },
            ],
      ...
      },
      {
        ...
        description: "El poder de Jesús sobre las fuerzas espirituales malignas.",
        isUnlocked: false,
        isCompleted: false,
        readings: [
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 8, startVerse: 28, endVerse: 34 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 9, startVerse: 32, endVerse: 34 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 12, startVerse: 22, endVerse: 29 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 1, startVerse: 21, endVerse: 28 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 5, startVerse: 1, endVerse: 20 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 4, startVerse: 31, endVerse: 37 },
            ],
            description: "El hombre con espíritu inmundo",
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 8, startVerse: 26, endVerse: 39 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 11, startVerse: 14, endVerse: 22 },
            ],
            description: "El mudo endemoniado",
          },
        ],
        ...
        readings: [
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 8, startVerse: 23, endVerse: 27 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 14, startVerse: 13, endVerse: 33 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 17, startVerse: 24, endVerse: 27 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 4, startVerse: 35, endVerse: 41 },
            ],
            description: "Jesús calma la tempestad",
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 6, startVerse: 45, endVerse: 52 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 8, startVerse: 22, endVerse: 25 },
            ],
            description: "Jesús calma la tempestad",
          },
          {
            ...
            bookId: BOOK_IDS["Juan"],
            verseRanges: [
              { chapter: 2, startVerse: 1, endVerse: 11 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Juan"],
            verseRanges: [
              { chapter: 6, startVerse: 1, endVerse: 21 },
            ],
            description: "Alimentación de 5,000 y caminar sobre el mar",
          },
        ],
      },
      {
        ...
        readings: [
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 9, startVerse: 18, endVerse: 26 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 7, startVerse: 11, endVerse: 17 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Juan"],
            verseRanges: [
              { chapter: 11, startVerse: 1, endVerse: 44 },
            ],
  ...
  },
  {
    ...
    description: "Capítulos donde se concentran sus parábolas más importantes y sus enseñanzas.",
    progress: 0,
    sections: [
      {
        ...
        readings: [
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            chapters: [13],
            description: "El sembrador, la cizaña, la mostaza, la levadura, el tesoro, la perla, la red",
          },
          {
            book: "Marcos",
            bookId: BOOK_IDS["Marcos"],
            chapters: [4],
            description: "El sembrador, la semilla que crece, el grano de mostaza",
          },
        ],
      },
      {
        ...
        readings: [
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 7, startVerse: 36, endVerse: 50 },
            ],
            description: "Los dos deudores (dentro del relato de la mujer pecadora)",
          },
          {
            book: "Lucas",
            bookId: BOOK_IDS["Lucas"],
      ...
      },
      {
        ...
        description: "Enseñanzas sobre la responsabilidad, el juicio y la fidelidad.",
        isUnlocked: false,
        isCompleted: false,
        readings: [
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 20, startVerse: 1, endVerse: 16 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 21, startVerse: 28, endVerse: 46 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            verseRanges: [
              { chapter: 22, startVerse: 1, endVerse: 14 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Marcos"],
            verseRanges: [
              { chapter: 12, startVerse: 1, endVerse: 12 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 12, startVerse: 13, endVerse: 21 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 14, startVerse: 7, endVerse: 24 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 16, startVerse: 1, endVerse: 31 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 19, startVerse: 11, endVerse: 27 },
            ],
      ...
      },
      {
        ...
        description: "Enseñanzas sobre cómo orar y la actitud correcta ante Dios.",
        isUnlocked: false,
        isCompleted: false,
        readings: [
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 18, startVerse: 1, endVerse: 14 },
            ],
  ...
  },
  {
    ...
    description: "Enseñanzas núcleo sobre el carácter del discípulo y la justicia del Reino.",
    progress: 0,
    sections: [
      {
        id: "sermon-del-monte-principal",
        title: "El Sermón del Monte",
        description: "El discurso más largo de Jesús: las Bienaventuranzas, la sal y la luz, la verdadera justicia.",
        isUnlocked: true,
        isCompleted: false,
        readings: [
          {
            ...
            description: "Las Bienaventuranzas, la ley y el amor, el Padre Nuestro, no juzgar",
          },
        ],
      },
      {
        ...
        readings: [
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 6, startVerse: 17, endVerse: 49 },
            ],
            description: "Bienaventuranzas y ayes, amar a los enemigos, no juzgar",
          },
        ],
      },
      {
        ...
        description: "Pasajes que profundizan en la vida del discípulo y la ética cristiana.",
        isUnlocked: false,
        isCompleted: false,
        readings: [
          {
          ...
          },
          {
            ...
            chapters: [12],
            description: "Ética cristiana en continuidad con el Sermón del Monte",
          },
        ],
      },
    ],
  },
  {
    ...
    description: "Desde la entrada triunfal hasta la resurrección y apariciones.",
    progress: 0,
    sections: [
      {
        id: "entrada-triunfal-confrontacion",
        title: "Entrada triunfal y confrontación en Jerusalén",
        description: "La llegada de Jesús a Jerusalén y sus últimas enseñanzas públicas.",
        isUnlocked: true,
        isCompleted: false,
        readings: [
          {
            ...
            description: "Entrada triunfal, purificación del templo, ayes a los fariseos",
          },
          {
            book: "Marcos",
            bookId: BOOK_IDS["Marcos"],
            chapters: createChapters(11, 12),
            description: "Entrada triunfal, higuera seca, autoridad cuestionada",
          },
          {
            book: "Lucas",
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 19, startVerse: 28, endVerse: 48 },
            ],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Juan"],
            chapters: [12],
            description: "La unción en Betania, entrada triunfal, griegos buscan a Jesús",
          },
        ],
      },
      {
        ...
        description: "Las profecías sobre el fin y las últimas enseñanzas privadas.",
        isUnlocked: false,
        isCompleted: false,
        readings: [
          {
            ...
            description: "Señales del fin, parábolas de vigilancia, juicio de las naciones",
          },
          {
            book: "Marcos",
            bookId: BOOK_IDS["Marcos"],
          ...
          },
          {
            ...
            bookId: BOOK_IDS["Lucas"],
            verseRanges: [
              { chapter: 21, startVerse: 5, endVerse: 36 },
            ],
          ...
          },
          {
            ...
            description: "Última cena, mandamiento nuevo, promesa del Espíritu, oración sacerdotal",
          },
        ],
      },
      {
        ...
        description: "Los eventos finales: arresto, crucifixión y resurrección gloriosa.",
        isUnlocked: false,
        isCompleted: false,
        readings: [
          {
            ...
            description: "Última cena, Getsemaní, juicio, crucifixión, resurrección",
          },
          {
            book: "Marcos",
            bookId: BOOK_IDS["Marcos"],
          ...
          },
          {
            ...
            description: "Última cena, juicio, crucifixión, resurrección, ascensión",
          },
          {
            book: "Juan",
            bookId: BOOK_IDS["Juan"],
            chapters: createChapters(18, 21),
            description: "Arresto, juicio, crucifixión, resurrección, apariciones",
          },
        ],
      },
    ],
  },
  {
    ...
    description: "Descubre cómo Jesús mostró amor y compasión a aquellos rechazados por la sociedad",
    sections: [
      {
      ...
      },
      {
        id: "mujeres",
        title: "Mujeres",
        description: "Jesús valora y dignifica a las mujeres en una cultura patriarcal",
        readings: [
          {
            book: "Lucas",
            bookId: BOOK_IDS["Lucas"],
  ...
  },
  {
    ...
    description: "Descubre las declaraciones \"Yo soy\" de Jesús que revelan su identidad divina",
    sections: [
      {
        id: "pan-de-vida",
        title: "Yo soy el pan de vida",
        description: "Jesús se presenta como el alimento espiritual que da vida eterna",
        readings: [
          {
            book: "Juan",
            bookId: BOOK_IDS["Juan"],
        ...
        readings: [
          {
            ...
            description: "\"Cuando levantéis al Hijo del Hombre, entonces conoceréis que Yo Soy\"",
          },
          {
            book: "Juan",
            bookId: BOOK_IDS["Juan"],
  ...
  },
  {
    ...
    description: "Descubre los diálogos clave de Jesús con diferentes personas y grupos",
    sections: [
      {
        id: "encuentros-sorprendentes",
        title: "Encuentros nocturnos y sorprendentes",
        description: "Conversaciones transformadoras con Nicodemo y la samaritana",
        readings: [
          {
            book: "Juan",
            bookId: BOOK_IDS["Juan"],
      ...
      },
      {
        ...
        description: "Jesús confronta a escribas y fariseos sobre la verdadera religión",
        readings: [
          {
            book: "Mateo",
            bookId: BOOK_IDS["Mateo"],
          ...
          },
          {
            ...
            description: "Preguntas capciosas: tributo, resurrección, mandamiento",
          },
          {
            book: "Mateo",
            bookId: BOOK_IDS["Mateo"],
    ...
    sections: [
      {
        ...
        description: "Las primeras promesas mesiánicas desde Génesis hasta el pacto davídico",
        readings: [
          {
            book: "Génesis",
        ...
        readings: [
          {
            ...
            chapters: [2],
            description: "El Hijo y Rey ungido (cf. Hechos 4:25-27; Hebreos 1:5)",
          },
          {
            book: "Salmos",
            bookId: BOOK_IDS["Salmos"],
            chapters: [22],
            description: "El sufrimiento del justo (cf. Mateo 27:35-46; Juan 19:23-24)",
          },
          {
            book: "Salmos",
            bookId: BOOK_IDS["Salmos"],
            chapters: [110],
            description: "Señor a la diestra de Dios (cf. Mateo 22:41-46; Hebreos 7)",
          },
          {
            book: "Salmos",
            bookId: BOOK_IDS["Salmos"],
      ...
      },
      {
        ...
        description: "Las profecías del Siervo de Jehová que sufre por su pueblo",
        readings: [
          {
            book: "Isaías",
            bookId: BOOK_IDS["Isaías"],
            verseRanges: [{ chapter: 40, startVerse: 3, endVerse: 5 }],
            description: "Voz que clama en el desierto: Juan el Bautista (cf. Mateo 3:3)",
          },
          {
            book: "Isaías",
            bookId: BOOK_IDS["Isaías"],
          ...
          },
          {
            ...
            description: "El Siervo Sufriente: herido por nuestras transgresiones",
          },
        ],
      },
    ],
        ...
        readings: [
          {
            ...
            description: "El gran mandamiento: amar a Dios y al prójimo (Mateo)",
          },
          {
            book: "Marcos",
            bookId: BOOK_IDS["Marcos"],
        ...
        readings: [
          {
            ...
            bookId: BOOK_IDS["Mateo"],
            chapters: [5, 6, 7],
            description: "Sermón del Monte: ira, reconciliación, amor a los enemigos",
          },
          {
            book: "Mateo",
            bookId: BOOK_IDS["Mateo"],
            chapters: [18],
            description: "Humildad como niño, corrección fraterna, perdón sin límite",
          },
          {
            book: "Marcos",
            bookId: BOOK_IDS["Marcos"],
